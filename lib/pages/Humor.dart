...
class _HumorState extends State<Humor> {
  ...
  final TextEditingController _selected_Index = TextEditingController();
  ...
  void saveHumorData() async {
    ...
    if (user != null) {
      ...
      await _firestore.collection('humor').add({
        'userId': userId,
        'statusHumor': _selected_Index.text,
        'bem': _bemController.text,
        'mal': _malController.text,
        'aprendizado': _aprendizadoController.text,
        'date': currentDate,
      });
    }
  }
